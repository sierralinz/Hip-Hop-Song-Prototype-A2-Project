...
setTempo(90)  
# Sets the BPM (beats per minute) of the track. 90 BPM is a classic hip-hop tempo.

# SOUND DEFINITIONS 
# Sounds = "clips" or "samples" 
# different intruments - (e.g., synth = synthenizer, electronic sound)
...
# Tiny pad for atmosphere (pad = a soft subtle background sound)
